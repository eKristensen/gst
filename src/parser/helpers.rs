use nom::{error::ParseError, IResult, combinator::{map, opt}, sequence::{pair, tuple, delimited}, bytes::complete::{take_until, tag}, Parser, character::complete::multispace0, multi::separated_list0, branch::alt};
...
pub fn opt_annotation<'a, F, O, E: ParseError<&'a str>>(inner: F)
-> impl FnMut(&'a str) -> IResult<&'a str, O, E>
where
